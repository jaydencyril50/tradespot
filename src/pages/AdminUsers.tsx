        ...
        {!loading && users.filter(user =>
          ...
          users.filter(user =>
            ...
            >
              ...
              <button
                style={{ position: 'absolute', top: 10, left: 10, background: '#e74c3c', color: '#fff', border: 'none', borderRadius: 0, padding: '4px 12px', fontWeight: 600, cursor: 'pointer', fontSize: 13 }}
