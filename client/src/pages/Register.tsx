        ...
        <div style={{ minHeight: '100vh', background: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <form onSubmit={handleSubmit} style={{
                ...
                <div style={{ marginBottom: '1rem', width: '90%' }}>
                    <label style={{ display: 'block', marginBottom: 6, color: '#333', fontWeight: 500, textAlign: 'left' }}>Full Name:</label>
                    <input
                        type="text"
                        value={fullName}
                ...
                <div style={{ marginBottom: '1rem', width: '90%' }}>
                    <label style={{ display: 'block', marginBottom: 6, color: '#333', fontWeight: 500, textAlign: 'left' }}>Confirm Password:</label>
                    <input
                        type="password"
                ...
                <div style={{ marginBottom: '1.5rem', width: '90%' }}>
                    <label style={{ display: 'block', marginBottom: 6, color: '#333', fontWeight: 500, textAlign: 'left' }}>TRC20 Wallet Address:</label>
                    <input
                        type="text"
                        value={wallet}
                ...
                <div style={{ marginBottom: '1rem', width: '90%' }}>
                    <label style={{ display: 'block', marginBottom: 6, color: '#333', fontWeight: 500, textAlign: 'left' }}>Referral Code:</label>
                    <input
                        type="text"
                        value={referredBy}
