    ...
    <div style={{ minHeight: '100vh', background: '#fff' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', marginTop: 30, gap: 20 }}>
        ...
        <div style={{
          ...
          <div style={{ fontWeight: 600, color: '#1e3c72', fontSize: 16 }}>USDT Balance: <span style={{ color: '#10c98f', fontWeight: 700 }}>{user.usdtBalance?.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span></div>
          <div style={{ fontWeight: 600, color: '#1e3c72', fontSize: 16 }}>SPOT Balance: <span style={{ color: '#2a5298', fontWeight: 700 }}>{user.spotBalance?.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span></div>
        </div>
        {/* Wallet Card */}
        <div style={{
          background: '#fff',
